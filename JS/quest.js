...
enviarResultado.addEventListener('click', function(){
    function enviarPorWhatsApp() {
        ...
        gruposPerguntas.forEach((grupo, index) => {
            ...
            const mensagemFormatada = `*Grupo ${grupo.title}:* ${mensagem}\n*Sim:* ${resultado.sim}\n*Não:* ${resultado.nao}`;
        ...
        const linkWhatsApp = `https://wa.me/5521982565890?text=Ol%C3%A1,%20Dra.%20Rayane!!%0AAqui%20est%C3%A1%20o%20meu%20Resultado:%0A%0A${mensagensFormatadas}`;
